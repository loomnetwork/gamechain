...
var (
	initFileName = flag.String("init-file", "tools/gamechain-replay/init.json", "path to genesis file")
	replayJSON   = flag.String("replay-json", "replays/match:1.json", "path to replay json file")
)
...
func main() {
	...
	readFromDBFlag, _ = strconv.ParseBool(os.Getenv("READ_FROM_DB"))
