...
func init() {
	...
	addDeckCmd.Flags().StringVarP(&addDeckCmdArgs.value, "value", "v", "{\"heroId\":\"1\", \"name\": \"exp\", \"cards\": [ {\"card_id\": 1, \"amount\": 2}, {\"card_id\": 2, \"amount\": 1} ]}", "Deck data in serialized json format")
}
