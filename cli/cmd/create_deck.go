...
func init() {
	...
	createDeckCmd.Flags().StringVarP(&createDeckCmdArgs.value, "value", "v", "{\"heroId\":\"1\", \"name\": \"NewDeck\", \"cards\": [ {\"card_name\": 1, \"amount\": 2}, {\"card_name\": 2, \"amount\": 1} ]}", "Deck data in serialized json format")
}
