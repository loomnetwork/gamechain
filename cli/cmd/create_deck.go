...
func init() {
	...
	createDeckCmd.Flags().StringVarP(&createDeckCmdArgs.value, "value", "v", "{\"heroId\":\"1\", \"name\": \"NewDeck\", \"cards\": [ {\"card_name\": \"Banshee\", \"amount\": 2}, {\"card_name\": \"Breezee\", \"amount\": 1} ]}", "Deck data in serialized json format")
}
